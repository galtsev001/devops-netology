...
`При помощи Packer можно создавать свои ami-образы для aws`
2. Если вы выполнили первый пункт, то добейтесь того, что бы команда `terraform plan` выполнялась без ошибок
* [terraform.plan](./config/terraform.plan)
3. Файлы конфигурации
* [main.tf](./config/main.tf)
* [outputs.tf](./config/outputs.tf)
* [versions.tf](./config/versions.tf)
